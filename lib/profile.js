...
function parse(user) {
    ...
    profile.id = user.id;
    profile.displayName = user.user_metadata.firstName + ' ' + user.user_metadata.lastName;
    profile.name = { familyName: user.user_metadata.lastName, givenName: user.user_metadata.firstName };
